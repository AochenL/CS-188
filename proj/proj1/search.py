...
def depthFirstSearch(problem: SearchProblem):
    ...
    frontier.push((startState, []))  # Stack stores tuples of (state, path_to_state)
...
def breadthFirstSearch(problem: SearchProblem):
    ...
    frontier = Queue()
    startState = problem.getStartState()
    frontier.push((startState, []))  # Queue stores tuples of (state, path_to_state)
...
def aStarSearch(problem: SearchProblem, heuristic=nullHeuristic):
    ...
    while not frontier.isEmpty():
        currentState, actions, gCost= frontier.pop()
        ...
        if currentState not in explored:
            ...
            for successor, action, stepCost in problem.getSuccessors(currentState):
                ...
                newFCost = newGCost + heuristic(successor, problem)
                frontier.update((successor, newActions, newGCost), newFCost)
